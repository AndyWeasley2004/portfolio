      ...
      <Section title="Activities & Gallery" id="activities" icon={Cpu}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {portfolioData.gallery.map((item) => (
            <div key={item.id} className="group relative aspect-square rounded-xl overflow-hidden bg-slate-800 border border-slate-800">
              <img 
              ...
              <div className="absolute bottom-0 left-0 p-4 transform translate-y-2 group-hover:translate-y-0 transition-transform">
                <p className="text-white font-medium text-sm leading-snug shadow-black drop-shadow-md">
                  {item.caption}
                </p>
              </div>
            </div>
