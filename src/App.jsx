        ...
        <div className="grid grid-cols-1 gap-6">
            <div className="mb-6">
                <p className="text-slate-400 max-w-2xl">
                    MIDI/Audio demonstrations of the paper, From Generality to Mastery, discussed in the papers above. 
                    These visualizations render one of best pieces generated by the model in MIDI format.
                </p>
            </div>
